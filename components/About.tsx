...
const About = () => {
  return (
    ...
    >
      {/* Optional subtle moving background */}
      ...
      <div className="relative z-10 mx-auto bg-[#161b22]/80 backdrop-blur-md p-6 sm:p-8 md:p-10 lg:p-12 rounded-xl max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl shadow-lg border border-[#58a6ff]/20">
        {/* Animated Title */}
        <ScrollAnimation direction="up" delay={0}>
          <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-[#58a6ff] font-bold mb-8">
            About Me
          </h2>
        </ScrollAnimation>
